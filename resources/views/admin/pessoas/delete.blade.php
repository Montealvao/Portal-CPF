        ...
        <div class="card portal-card border-danger">
            ...
            <div class="card-body">
                <div class="alert alert-warning mb-4">
                    ...
                    Esta ação é <strong>irreversível</strong>. Todos os CPFs vinculados a esta pessoa também serão removidos.
                </div>
                ...
                <div class="delete-preview p-3 rounded mb-4" style="background:var(--bs-light);">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <p class="fw-bold fs-5 mb-0">{{ $pessoa->nome }}</p>
                            <p class="text-muted mb-0 font-monospace">{{ $pessoa->cpf_principal }}</p>
