        ...
        <div class="card portal-card border-danger">
            ...
            <div class="card-body">
                <div class="alert alert-warning mb-4">
                    ...
                    Esta ação é <strong>irreversível</strong>. O CPF será removido permanentemente.
                </div>
                ...
                <div class="delete-preview p-3 rounded mb-4" style="background:var(--bs-light);">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <p class="fw-bold fs-5 mb-0 font-monospace">
                                {{ $cpf->numero }}
                            </p>
                            ...
                            <p class="text-muted mb-0" style="font-size:0.8rem;">
                                Cadastrado em {{ $cpf->created_at?->format('d/m/Y') }}
                            </p>
                        </div>
                    </div>
                </div>
